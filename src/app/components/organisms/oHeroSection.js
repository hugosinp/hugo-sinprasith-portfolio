...
const OHeroSection = () => {
    return (
        <Container maxW={'4xl'} py={{ base: 30, lg: 40 }} centerContent>
            <Flex h={{ base: "auto" }} direction={{ base: "column", lg: "row"}} align={'center'}>
                <Stack as={Box} textAlign={{ base: 'center', lg: 'start' }}>
                    ...
                    <Text fontSize={'xl'} as={'span'} color={'blue.300'}>
                        <Text as="span" fontWeight={'bold'} bgClip='text' bgGradient='linear(to-r, #4DB8FF, #19A3FF)'>Full-stack Developer</Text> based in Paris.
                    </Text>
                </Stack>
                <Stack mt={{ base: 10 }}>
